...
Usage:
    python clone_repo.py <k8s_deployment> <repository_url> [destination_directory]
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python clone_repo.py <k8s_deployment> <repository_url> [destination_directory]")
        sys.exit(1)
